...
When `auto_update: true` is configured, fields automatically process when new patient logs are added to the system. This happens in the background without additional API calls.

**How it works:**
1. New patient log is created in the system
2. NarraFields detects the new log
...
**Processing time:** Typically completes within 5-10 seconds of log creation.
