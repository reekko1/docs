---
title: 'Overview'
description: 'Comprehensive guide to NarraOS backend APIs for internal teams'
---
Welcome to the comprehensive API documentation for NarraOS's backend services. This documentation is designed for internal team members - both newcomers getting started and senior developers needing quick reference.
...
<CardGroup cols={2}>
  <Card title="Core Features" icon="stethoscope" href="/api-reference/chat-v2">
    **AI Clinical Assistant, Manual Lenses Entry, Clinical Log Processing**
    ...
    The heart of NarraOS - AI assistance, clinical data management, and log processing with real-time streaming.
  </Card>
  
  <Card title="Data Entry Support" icon="pen-to-square" href="/api-reference/meta-routes">
    **Dynamic Form Fields, File Upload & Storage, Knowledge Upload, Media Deletion**
    
    Tools that make clinical documentation effortless - dynamic forms, media handling, AI document processing, and complete file cleanup.
  </Card>
  ...
  <Card title="Administration" icon="gear" href="/api-reference/fcm">
    **Push Notifications, Subscription Management, Endpoint Management**
    
    Admin tools for managing notifications, subscription operations, and API endpoint configurations.
  </Card>
</CardGroup>
...
### Lenses
In NarraOS, **lenses** are the different categories of clinical data we track:
...
NarraOS supports multiple ways to create clinical documentation:
...
<Steps>
  <Step title="Choose Your Starting Point">
    **New to NarraOS?** Start with [AI Clinical Assistant](/api-reference/chat-v2) to understand our AI assistant.
