...
---
The Chat V2 endpoint is the heart of Narra's AI assistant. It's our GPT-4-powered orchestrator that helps providers get clinical insights, search medical literature, query patient logs, and access our knowledge base - all through a conversational interface.
