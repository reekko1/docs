...
---
The Chat V2 endpoint is the heart of NarraOS's AI assistant. It's our GPT-4-powered orchestrator that helps providers get clinical insights, search medical literature, query patient logs, and access our knowledge base - all through a conversational interface.
...
```bash cURL
curl -X POST https://api.narra.com/api/v1/chat \
...
response = requests.post(
    "https://api.narra.com/api/v1/chat",
...
- Look for `correlation_id` to trace a specific request
</Tip>
