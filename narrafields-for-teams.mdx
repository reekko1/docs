...
<AccordionGroup>
  ...
  <Accordion title="Family Medicine">
    ...
    **Your Instructions:**
    > Categorize drinking pattern: "None" = no alcohol, "Social" = occasional/special occasions only, "Regular" = weekly consumption but within guidelines, "Heavy" = daily or excessive amounts, "Concerning" = binge drinking or negative consequences mentioned.
  ...
  <Accordion title="Urgent Care">
    ...
    **Your Instructions:**
    > Rate symptom impact on daily activities: "Minimal" = slight bother but normal activities, "Moderate" = some activity limitation, "Significant" = major impact on daily function, "Severe" = unable to perform normal activities.
